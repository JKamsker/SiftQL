...
public sealed class FilterArrayContainsTests
{
    ...
    [Fact] public void ContainsBoolean_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsBoolean(new bool[257], true));
    ...
    [Fact] public void ContainsByte_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsByte(new byte[257], 1.0));
    ...
    [Fact] public void ContainsSByte_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsSByte(new sbyte[257], 1.0));
    ...
    [Fact] public void ContainsInt16_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsInt16(new short[257], 1.0));
    ...
    [Fact] public void ContainsUInt16_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsUInt16(new ushort[257], 1.0));
    ...
    [Fact] public void ContainsInt32_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsInt32(new int[257], 1.0));
    ...
    [Fact] public void ContainsUInt32_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsUInt32(new uint[257], 1.0));
    ...
    [Fact] public void ContainsInt64_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsInt64(new long[257], 1.0));
    ...
    [Fact] public void ContainsUInt64_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsUInt64(new ulong[257], 1.0));
    ...
    [Fact] public void ContainsSingle_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsSingle(new float[257], 1.0f));
    ...
    [Fact] public void ContainsDouble_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsDouble(new double[257], 1.0));
    ...
    [Fact] public void ContainsDecimalValue_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsDecimalValue(new decimal[257], 1m));
    ...
    [Fact] public void ContainsString_OversizedArray_Throws() => AssertOversized(() => FilterArrayContains.ContainsString(new string[257], "x"));
    ...
    [Fact] public void ContainsGuid_Oversized_Throws() => AssertOversized(() => FilterArrayContains.ContainsGuid(new Guid[257], Guid.Empty));
    ...
    private static void AssertOversized(Func<bool> contains) =>
        Assert.Throws<InvalidOperationException>(() => contains());
}
